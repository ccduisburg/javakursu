...
public class DieBohne {//Datei die über "publíc" für jeden sichtbar ist
 ...
 /*
       ...
       for(int i =0; i<10; i=i+2){
        ...
        int produktAnzahl = 6;
        String[] sorten = new String[produktAnzahl];//sorten.length=produktAnzahl, und das ist unveränderbar
        ...
        for (char groesse : groessen) {
            System.out.println("Diese Grösse gibt es bei uns: " + groesse);
        }
        groessen[1] = 'M';
        groessen[0] = 'K';
        groessen[2] = 'G';
        ...
        feld3[4]=new int[122];
        feld3[0][0]=1;
        System.out.println("In feld3[0][0]: "+feld3[0][0]);
        feld1[0][0] = 1;
        //int[] element = {2,4,6,8};
        //feld1[0]=element;
        int[][] feld4 = {{11,2,13},{3,4,5},{5,6,7,8},{33}, {3,6,9,12}};
        System.out.println("Was steckt in +feld4[0][2]: " +feld4[0][2] );
        System.out.println("Die 3 steckt in: " +feld4[1][0] );
        for(int i: feld4[3]){
            System.out.print(i+ " ");
        }
        System.out.println("");
        int[][] feld2 = new int[3][3];//Abkürzung für:
        int[][] feld2_1 = new int[3][];
        feld2_1[0]=new int[3];
        feld2_1[1]=new int[3];
        feld2_1[2]=new int[3];
        */
        ...
        System.out.println("Welche Sorte soll es sein?");
        gewaehlteSorte =eingabe.nextInt();
        System.out.println("Gewählt wurde: "+gewaehlteSorte);
        
        meinNeuerKunde.bestellen(gewaehlteSorte,10);
        meinNeuerKunde.bezahlen();
        //meinNeuerKunde.rechnung=0;
        System.out.println("Tschüss, komm bald wieder "+meinNeuerKunde.gebeName());

        Werbung werbung = new Werbung();
        //werbung.zeigeAlleKundenAn();
        Kunde k1 = new Kunde();
        k1.setzeDenNamen("Justus");
        werbung.kundeZufuegen(k1);
        //werbung.zeigeAlleKundenAn();
        Kunde k2 = new Kunde();
        k2.setzeDenNamen("Peter"); 
        Kunde k3 = new Kunde();
        k3.setzeDenNamen("Bob");
        werbung.kundeZufuegen(k2);
        werbung.kundeZufuegen(k3);
        //werbung.zeigeAlleKundenAn();
        werbung.kundeZufuegen(meinNeuerKunde);
        werbung.zeigeAlleKundenAn();
        werbung.anredeAendern();
        werbung.zeigeAlleKundenAn();
*/
        Werbung test = new Werbung();
        test.zahlenKram();
    } 
